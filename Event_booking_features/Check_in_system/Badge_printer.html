...
<body>
    <div class="venue-container">
        <div class="nav-bar">
            <a href="QR_scan.html" class="nav-link">QR Scanner</a>
            <a href="Atn_lookup.html" class="nav-link">Attendee Lookup</a>
            <a href="Badge_printer.html" class="nav-link active">Badge Printer</a>
        </div>
