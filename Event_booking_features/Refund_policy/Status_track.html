...
<body>
    <div class="venue-container">
        <div class="nav-bar">
            ...
            <a href="Cancel_req.html" class="nav-link">Request</a>
            <a href="Status_track.html" class="nav-link active">Status</a>
        </div>
        ...
        <div class="refund-container">
            <div class="refund-section">
                ...
                <div id="noRequest" style="text-align: center; padding: 20px;">
                    ...
                    <a href="Cancel_req.html" class="btn-pay" style="display: inline-block; width: auto; margin-top: 15px;">
                        Submit a Request
                    </a>
                </div>
