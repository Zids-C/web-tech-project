...
<body>
    <div class="venue-container">
        <div class="nav-bar">
            <a href="Disc_entry.html" class="nav-link active">Apply Code</a>
            <a href="Code_gen.html" class="nav-link">Generate Code</a>
            <a href="Red_analytics.html" class="nav-link">Analytics</a>
        </div>
